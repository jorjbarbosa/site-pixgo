...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css" i>
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/pixgo.css">
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/dashboard.css">
  </head>

  <body>
    <nav class="navbar navbar-dark fixed-top bg-pixgo flex-md-nowrap p-0 shadow">
